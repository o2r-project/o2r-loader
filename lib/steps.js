...
function extractMetadata(passon) {
    return new Promise((fulfill, reject) => {
        ...
        let start_options = Object.assign(config.meta.container.default_start_options, {});
        let cmd = [
            '-debug',
        ...
        global.docker.run(config.meta.container.image, cmd, containerLogStream, create_options, start_options, (err, data, container) => {
