...
function syncWebdav(remotePath, localPath) {
                ...
                switch(contents[i].type) {
                    case 'file':
                        passon.client
                            ...
                            break;
                    case 'directory':
                        syncWebdav(contents[i].filename, localPath);
                }
            }           
        })
        .catch(function(err) {
...
function publicShareLoad(passon) {
    return new Promise((fulfill, reject) => {
        ...
        /* 
            ...
            2. if 1 zip file -> unzip
            3. if 1 directory -> change to directory and go to 1.
